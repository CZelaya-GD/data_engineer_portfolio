...
**Business Value**: Track bot activity, trending topics, daily leaders across 112K issues.
...
## 📊 Live Endpoints (http://127.0.0.1:5000)
...
# Day 17: API Server
python serve_hn.py       # → http://127.0.0.1:5000
